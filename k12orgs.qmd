...
enrollment.original <-read_csv("~/Library/CloudStorage/GoogleDrive-kasche@ruralmn.org/My Drive/Research/FY25-27/FY27/OHE Journey to meaningful employment/Data/CRPD 2 (angelique.workman@state.mn.us)/K12Enrollment.csv")  %>%
  mutate(PersonID = as.integer(PersonID),
         K12OrganizationID = as.integer(K12OrganizationID)) %>%
  drop_na(PersonID)

SiteCountyCode <- read_csv("~/Library/CloudStorage/GoogleDrive-kasche@ruralmn.org/My Drive/Research/FY25-27/FY27/OHE Journey to meaningful employment/Data/SiteCountyCodes.csv")

k12.org.original <- read_csv('/Users/kellyasche/Library/CloudStorage/GoogleDrive-kasche@ruralmn.org/My Drive/Research/FY25-27/FY27/OHE Journey to meaningful employment/Data/CRPD 2 (angelique.workman@state.mn.us)/K12Organization_cleaned.csv') %>%
