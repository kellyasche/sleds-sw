...
```{r ap original data}
ap.original <- read_csv('/Users/kellyasche/Library/CloudStorage/GoogleDrive-kasche@ruralmn.org/My Drive/Research/FY25-27/FY27/OHE Journey to meaningful employment/Data/CRPD 2 (angelique.workman@state.mn.us)/AdvancedPlacementSATPSAT_AP.csv') %>%
